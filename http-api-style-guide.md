...
|`409 Conflict` | The server MUST return this status code when it detects a conflict with another in-flight request. Only POST requests that support idempotency, should use this code. |
|`412 Precondition Failed` | The server MUST return this status code when the resource state specified by the `ETag` value in the precondition header `If-Match` does not match with the server side state. |
|`413 Payload Too Large` | The server MUST return this status code when the request entity is larger than the limits defined by the server. |
...
##### Example
A common need is to extend a common type with additional fields. In this example, we will extend the [address](common-components/v1/schema/json/openapi-2.0/address_portable.json) with a `type` field.
...
* The  Common Type [`percentage.json`](common-components/v1/schema/json/openapi-2.0/percentage.json) MUST be used. This ensures that the rate is represented as a fixed-point decimal.
...
* [`country_code`](common-components/v1/schema/json/openapi-2.0/country_code.json)
...
* [`currency_code`](common-components/v1/schema/json/openapi-2.0/currency_code.json)
...
* [`language.json`](common-components/v1/schema/json/openapi-2.0/language.json)
 	* Language type uses [BCP-47](https://tools.ietf.org/html/bcp47) language tag.
* [`locale.json`](common-components/v1/schema/json/openapi-2.0/locale.json)
...
* [`province.json`](common-components/v1/schema/json/openapi-2.0/province.json) 
...
* [`date_time.json`](common-components/v1/schema/json/openapi-2.0/date_time.json) SHOULD be used to express an RFC3339 `date-time`.
* [`date_no_time.json`](common-components/v1/schema/json/openapi-2.0/date_no_time.json) SHOULD be used to express `full-date` from RFC 3339.
* [`time_nodate.json`](common-components/v1/schema/json/openapi-2.0/time_nodate.json) SHOULD be used to express `full-time` from RFC3339.
* [`date_year_month.json`](common-components/v1/schema/json/openapi-2.0/date_year_month.json) SHOULD be used to express a floating date that contains only the **month** and **year**. For example, card expiry date (`2016-09`).
* [`time_zone.json`](common-components/v1/schema/json/openapi-2.0/time_zone.json) SHOULD be used for expressing timezone of a RFC3339 `date-time` or a `full-time` field.
...
| `INVALID_PARAMETER_VALUE` | The value of a field is invalid. | 400 |
...
3. `error_catalog_issue.json` is where the main error cause information is documented.
    ...
    * `fields`:
        ...
        - `description`: A human-readable description of the error cause.  This value may not match the `description` field in the Error issue response at runtime because that value may have more contextual information that it can present to the client.
...
<h1 id="openapi-extensions">OpenAPI Extensions</h1>

### **Schema extension `x-deprecated`**

Marks an API element as deprecated in the definition of the API. For more details, see [Deprecation](#deprecation).

**Location:**
<code>operation</code>. Optional.
...
"x-deprecated": [
  {
    "api_element": "transaction_evaluation_response.json#/address",
    "see": "transaction_evaluation_response.json#/global_address",
    "since_version": "1.4"
  }
]
~~~

### **Schema extension `x-enum`**

Specifies all the possible values for the <code>string</code>. Optional <code>description</code> and <code>x-visibility</code> can also be provided, and are used to prepare documentation.

**Location:**

<code>string</code> schema properties. Optional.  
...
"payment_status": {
  ...
  "x-enum": [
    {
      "value": "PENDING",
      "description": "Pending state of an order."
    },
    {
      "value": "CAPTURED",
    ...
    {
      "value : "AUTHORIZED",
      "description": "Authorized state of an order."
    },
    {
      "value": "COMPLETED",
      "description": "Completed state of an order.",
      "visibility": {
        "extent": "EXTERNAL"
      }
    },
    {
      "value": "TEST_STATUS",
      "description": "Status only an internal order can have.",
      "visibility": {
        "extent": "INTERNAL"
      }
    }
...
### **Schema extension `x-links`**

A design-time list of possible links in a response.

**Location:**

<code>operation.response</code>. Optional.
...
"x-links": [
  {
    "rel": "start",
    "href": "/v1/wallet/credit-cards?page_size={page_size}&page={page}",
    "method": "GET"
  },
  {
    "rel": "next",
    "href": "/v1/wallet/credit-cards?page_size={page_size}&page={page+1},
    "method": "GET"
  },
  {
    "rel": "prev",
  ...
  {
    "rel": "last",
    "href": "/v1/wallet/credit-cards?page_size={page_size}&page={last}",
    "method": "GET"
  }
]
~~~
...
### **Schema extension `x-pattern`**

A cross-reference to a schema file that contains one or more regular expression patterns for validation. Each pattern is associated with a country code or another conditional value. Some common components, such as <code>address_portable.json</code>, <code>name.json</code>, and <code>business-name.json</code> use this property to define validation files that contain country code- or other condition-based regular expression patterns. 

**Location:**

Optional. Include in schema files for validation purposes.
...
### **Schema extension `x-unsupportedFields`**

Describes the fields of a common component that are not supported by the API.

**Location:**

<code>schema</code> properties. Optional.
...
~~~
"shipping_address": {
  "$ref": "./common_components_v3/address.portable.json",
  "x-unsupportedFields": ["admin_area_3","admin_area_4"]
  }
~~~


### **Schema extension `x-requiredOverride`**

Describes the overrides for `required` fields of a common component when the default set of `required` fields are not applicable.
Default `required` field set from the reference will be **replaced** with the new set provided. 
...
~~~
"shipping_address": {
     "x-requiredOverride": ["address_line_1","address_line_2", "admin_area_1", "admin_area2", "postal_code"],
      "$ref": "./common_components_v3/address.portable.json"
  }
~~~


### **Schema extension `x-serviceName`**

The service name. A character string from 1 to 40 characters long.

**Location:**

* <code>root.info</code>. Optional.
* <code>operation</code>. Optional.
...
~~~
"x-serviceName": "fooserv"
~~~

### **Schema extension `x-serviceDomain`**

The service domain name. Use this when the API Specification is implemented by multiple services, for exampple, the `GET` API operation is implemented by one service vs the `POST` API operation is implemented by another service. The service domain name should be same as the API Product name.
...
~~~
"x-serviceDomain": "checkout-orders"
~~~

### **Schema extension `x-slo`**

The service-level objectives for each method, including:

* A 95th percentile response time for this API method, in milliseconds.
* The acceptable number of errors, as a percent.
...
~~~
"x-slo": {
  "x-responseTime95thPercentile": 200,
  "x-errorRate": 0.001
}
~~~

### **Schema extension `x-supportedCountries`**

* A list of supported countries.
* If you omit this list, the default is support in ALL countries.
* Intended for use in developer documentation.

**Location:**

* <code>root.info</code>. Optional.
* <code>operation</code>. Optional.
* <code>parameter</code>. Optional.
...
"x-supportedCountries": [
  {
    "code": "US",
    "condition": "US-issued instruments only are supported."
  }
]
~~~


### **Schema extension `x-visibility`**

* Limits the visibility of schema and sub-schema documentation to appropriate audiences.
* Indicates the extent to which this node is visible outside of a company.
* Value is:
	* <code>INTERNAL</code>. The default.
	* <code>PARTNER</code>
	* <code>EXTERNAL</code>
...
* The <code>operation</code> property. Optional.
* The <code>operation</code> parameter. Optional.
* The <code>schema</code> property. Optional.
...
### **Schema extension `x-dataClassification`**

* Marks an API element with appropriate data classification for the element.

**Location:**

* <code>parameter</code>. Mandatory.
* <code>schema</code> properties. Mandatory.
...
"parameters": [
        {
            "name": "alias",
            "description": "The alias of a person name.",
            "in": "query",
            "type": "string",
            "required": false,
            "x-dataClassification": {"data_class":"Foo", "data_category":"Bar"}
        }
  ...
~~~
...
[13]: common-components/v1/schema/json/openapi-2.0 "Common Types"
[14]: common-components/v1/schema/json/openapi-2.0/README.md "README"
[15]: common-components/v1/schema/json/openapi-2.0/money.json "money_json"
...
[18]: deprecated/v1/schema/json/README_address.md "README Address"
[19]: common-components/v1/schema/json/openapi-2.0/address_portable.json "address_portable.json"
...
[22]: common-components/v1/schema/json/openapi-2.0/error.json "error.json"
[23]: http://tools.ietf.org/html/rfc6901 "JavaScript Object Notation (JSON) Pointer"
[24]: common-components/v1/schema/json/openapi-2.0/error_spec.json "error_spec.json"
[25]: common-components/v1/schema/json/openapi-2.0/error_spec_issue.json "error_spec_issue.json"
[26]: common-components/v1/schema/json/openapi-2.0/error_catalog.json "error_catalog.json"
[27]: common-components/v1/schema/json/openapi-2.0/error_catalog_item.json "error_catalog_item.json"
[28]: vcommon-components/v1/schema/json/openapi-2.0/error_details.json "error_details.json"
